...
export class RemoteData extends CompleterBaseData {
    ...
    public search(term: string): void {
        ...
        this.remoteSearch = this.http.get(url, this._requestOptions.merge())
            .map((res: Response) => { var myresponse = res.json(); if(myresponse['suggest']['user-suggest']) {myresponse = myresponse['suggest']['user-suggest'][0]['options'];} console.log('murthyoffers/ng2-completer'); console.log(myresponse); return myresponse;})
            .map((data: any) => {
